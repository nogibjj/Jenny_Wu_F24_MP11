...
# MAGIC     SELECT *
# MAGIC     FROM ids706_data_engineering.jcw131_nyc_shooting.jcw131_nyc_shooting_transformed
# MAGIC     WHERE Occur_Date = '04/19/2008'
# MAGIC """, delta_table_name="ids706_data_engineering.jcw131_nyc_shooting.jcw131_nyc_shooting_transformed")
# MAGIC
